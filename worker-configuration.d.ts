/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: bd4645b9f16b7e17505359071a96fa5b)
// Runtime types generated with workerd@1.20260831.1 2026-06-07 
interface __BaseEnv_Env {
	FACEBOOK_AUTH: KVNamespace;
	APP_SECRET: string;
